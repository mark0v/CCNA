...
Language: Russian
Translation pair: articles-en/2026-07/week-13/02-extended-acls-protocol-source-destination.md

## Summary

- Extended ACLs выглядят сложными, но каждая строка строится вокруг трех решений: protocol, source, destination.
- Extended ACLs могут match не только source, но и destination, protocol and port.

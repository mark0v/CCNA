...
Language: Russian
Translation pair: articles-en/2026-05/week-04/08-why-ip-addressing-is-important.md

## Summary

IP addressing - это фундамент, без которого невозможно уйти дальше basic switching. Switches помогают устройствам общаться внутри local network по MAC addresses, но IP addresses дают устройствам logical identity and structure, чтобы traffic мог идти к нужным destinations, в том числе за пределы локального segment.

Главная мысль: IP address - это не случайное число на устройстве. Это logical address, который помогает network understand where devices are and how communication should be organized.

...
Language: English
Translation pair: articles/2026-05/week-03/10-navigating-the-cisco-ios-software.md

## Summary

Cisco IOS is the command-line operating system network engineers use to configure and verify Cisco routers and switches. To work confidently with a device, you need to understand modes, prompts and context: where you can only look around, where you can run privileged commands and where configuration changes happen.

Main idea: the Cisco CLI is not just a list of commands. It is a structured environment where each command belongs in the correct mode.

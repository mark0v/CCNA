...
Language: English
Translation pair: articles/2026-05/week-05/12-routers-connect-networks.md

## Summary

This lesson reinforces the main role of routers: they exist to connect different networks. A switch helps devices communicate inside one LAN, but when traffic needs to reach another subnet, another site or the internet, a router is required.

Main idea: every router interface is a network. If one router interface faces the cafe LAN and another faces a WAN link, the router is sitting between two different networks and decides where packets should go next.

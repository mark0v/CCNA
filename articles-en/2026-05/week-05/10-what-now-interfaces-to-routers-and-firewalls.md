...
Language: English
Translation pair: articles/2026-05/week-05/10-what-now-interfaces-to-routers-and-firewalls.md

## Summary

This lesson is a checkpoint after the interfaces section. We now understand how to configure connection points, how to read interface status and counters, how speed affects real communication, and why troubleshooting often starts at the port.

Main idea: if you understand interfaces, it becomes much easier to move into routers and firewalls, because they also work through interfaces, but now they make decisions about traffic between networks and the outside world.

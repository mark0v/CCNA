...
Language: English
Translation pair: articles/2026-05/week-04/06-using-cam-table-to-track-down-devices.md

## Summary

One of the most practical network administration skills is finding where a device is physically connected. The process usually starts with an IP address: generate traffic, get the MAC through ARP, find that MAC in the CAM/MAC address table, identify the port, check whether it is an uplink, then move to the next switch and repeat until you find the final access port.

Main idea: if you can follow a MAC address across switches, you can solve a huge number of real troubleshooting problems.

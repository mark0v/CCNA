...
Language: English
Translation pair: articles/2026-07/week-12/07-building-ipv6-between-sites-with-static-routes.md

## Summary

- IPv6 becomes easier to understand when you configure it on a topology instead of only reading address theory.
